...
import { generateRestaurantDescription } from '@/lib/gemini'
...
export default function CreatePostPage() {
    ...
    const editor = useEditor({
        ...
        editorProps: {
            attributes: {
                class: 'p-4 rounded-xl border bg-white min-h-[200px] text-sm leading-relaxed focus:outline-none',
    ...
    return (
        <main className="max-w-5xl mx-auto p-6 bg-white rounded-2xl shadow-xl space-y-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
                ...
                {/* RIGHT: Description */}
                <div className="bg-white border rounded-xl p-4 space-y-2 min-h-[300px]">
...
<Button
  variant="secondary"
  disabled={!title || !editor}
  onClick={async () => {
    console.log('✨ Auto generate clicked')
    const content = await generateRestaurantDescription(title)
